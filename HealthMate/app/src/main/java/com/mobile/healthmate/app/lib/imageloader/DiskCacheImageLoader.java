...
import com.mobile.healthmate.app.lib.imageloader.cache.BitmapDiskCache;
...
public class DiskCacheImageLoader {
    ...
    private class GetTask extends MyAsyncTask<Bitmap> {
        String key;
    ...
    private class ClearTask extends MyAsyncTask<Void> {
